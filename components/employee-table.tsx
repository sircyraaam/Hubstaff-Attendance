          ...
          <table className="w-full">
            <thead>
              <tr className="border-y border-border/50 bg-muted/30">
                <th className="text-left py-4 px-6 text-sm font-bold">Employee</th>
                <th className="text-left py-4 px-6 text-sm font-bold">Status</th>
                <th className="text-left py-4 px-6 text-sm font-bold">Shift Start</th>
                <th className="text-left py-4 px-6 text-sm font-bold">Actual Start</th>
                <th className="text-left py-4 px-6 text-sm font-bold">Late Duration</th>
                <th className="text-left py-4 px-6 text-sm font-bold">Hours Worked</th>
              </tr>
            </thead>
